...
library(knitr)
library(magrittr)
ruta_excel <- "all/01_TablasDescriptivas/idx7_gini_summary_labels.xlsx"
...
<div style="display: flex; gap: 10px; justify-content: center; align-items: center;">
  <img src="all/idx7_gini_radar_PC1.png" width="300px" />
  <img src="all/idx7_gini_radar_PC2.png" width="300px" />
</div>

```{r, fig.cap = 'Resultados completos en PNG'}
knitr::include_graphics("all/02_Imagenes/idx7_gini_results.png")
```
...
```{r}
ruta_excel <- "all/idx7_gini_loadings_y_tops.xlsx"
...
knitr::include_graphics("all/02_Imagenes/idx7_gini_map_pcall.png")
```
...
[Descargar base de datos IDX 7](/03_DS/idx7_gini.xlsx)

## Descarga de gráficos y acceso a código fuente

<div class="btn-group" role="group">
  <a href="all/idx7_gini_radar_PC1.png" class="btn btn-primary" download>Descargar Radar PC1</a>
  <a href="all/idx7_gini_radar_PC2.png" class="btn btn-primary" download>Descargar Radar PC2</a>
  <a href="all/02_Imagenes/idx7_gini_map_pc1.png" class="btn btn-info" download>Descargar Mapa PC1</a>
  <a href="all/02_Imagenes/idx7_gini_map_pc2.png" class="btn btn-info" download>Descargar Mapa PC2</a>
  <a href="all/02_Imagenes/idx7_gini_map_pcall.png" class="btn btn-info" download>Descargar Mapa Todos los PCs</a>
  <a href="all/02_Imagenes/idx7_gini_results.png" class="btn btn-success" download>Descargar Resultados Completos</a>
  <a href="all/idx7_gini_loadings_y_tops.xlsx" class="btn btn-warning" download>Descargar Excel de Loadings y Tops</a>
  <a href="all/01_TablasDescriptivas/idx7_gini_summary_labels.xlsx" class="btn btn-warning" download>Descargar Tabla Descriptiva</a>
</div>
