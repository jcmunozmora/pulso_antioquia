---
title: "Las Antioquias - Metodología"
format:
  html:
    toc: true
    toc-depth: 3
...
![](all/04_Cluster/cluster_dist.png){fig-alt="Matriz de distancia euclídea" fig-cap="Matriz de distancia euclídea" width="100%"}
...
![](all/04_Cluster/cluster_elbow.png){fig-alt="Método del codo para estimar k óptimo" fig-cap="Método del codo para estimar el número óptimo de clústeres" width="80%"}
...
::: {layout-ncol=2}
![](all/04_Cluster/cluster_dendo.png){fig-alt="Dendrograma (AGNES)" fig-cap="Dendrograma (AGNES)" width="100%"}
![](all/04_Cluster/cluster_dendo_vars.png){fig-alt="Dendrograma con variables" fig-cap="Dendrograma por variables" width="100%"}
:::
...
![](all/04_Cluster/cluster_variables_contexto_1.png){fig-alt="Medias de indicadores de contexto (1) por clúster" fig-cap="Medias de indicadores de contexto por clúster" width="80%"}

![](all/04_Cluster/cluster_variables_contexto_2.png){fig-alt="Medias de indicadores de contexto (2) por clúster" fig-cap="Medias de indicadores de contexto por clúster" width="80%"}

![](all/04_Cluster/cluster_variables_res_1.png){fig-alt="Medias de indicadores de resultado por clúster" fig-cap="Medias de indicadores de resultado por clúster" width="80%"}
